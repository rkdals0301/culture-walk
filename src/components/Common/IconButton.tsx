...
const IconButton = ({
  ...
  const baseClass =
    'inline-flex items-center justify-center rounded-xl border font-bold transition-all duration-150 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--color-focus-ring)]';
  ...
  const buttonClass = twMerge(
    clsx(
      ...
      colorClass,
      disabledClass,
      fullWidth ? 'w-full' : label ? 'min-h-10 shrink-0' : 'size-10 shrink-0',
      label && 'gap-1.5 px-3',
      className
    )
  );
