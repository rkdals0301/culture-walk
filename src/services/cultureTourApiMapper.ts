...
import type { TourApiFestival } from '@/types/culture';

import { createTourApiSourceKey } from './cultureIdentity';
import { normalizeTourApiImageUrl } from './tourApiDetails';
...
export const mapTourApiFestivalToCulture = (festival: TourApiFestival): NewCultureRow => {
